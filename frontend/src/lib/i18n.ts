...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'home.custom_deck_label': { ja: 'カスタムお題（任意）', en: 'Custom Topics (optional)', ko: '커스텀 주제 (선택)' },
  'home.custom_deck_placeholder': {
    ja: '1行に1つずつ入力（最大50個）\n例:\n海に行く\nカラオケ\nラーメン食べる',
    en: 'One topic per line (max 50)\nExample:\nGo to the beach\nKaraoke\nEat ramen',
    ko: '한 줄에 하나씩 입력 (최대 50개)\n예:\n바다에 가기\n노래방\n라면 먹기',
  },
  'home.custom_deck_hint': {
    ja: 'カスタムお題を入力するとカテゴリ選択は無視されます',
    en: 'Custom topics override category selection',
    ko: '커스텀 주제를 입력하면 카테고리 선택이 무시됩니다',
  },
